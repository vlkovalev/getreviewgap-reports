...
export const faqs = [
  {
    question: "Why focus on reviews and sentiment first?",
    answer: "It is the clearest SMB gap: product teams and agencies need review intelligence, but enterprise tools are expensive and broader marketplace analytics tools often bury sentiment inside complex suites."
  },
  {
    question: "Does this scrape live Amazon reviews?",
    answer: "The MVP can connect to an Apify Amazon reviews actor when API keys are configured. Without keys, it runs in demo mode or analyzes pasted reviews."
  },
  {
  ...
  },
  {
    ...
    answer: "No. It is a fast first-pass report that highlights patterns, objections, buyer language, and product opportunities from review data."
  },
  {
    question: "Can I use it before launching a product?",
    answer: "Yes. Paste competitor URLs or review excerpts to find complaints you can avoid and messages your product page should answer."
  }
]
