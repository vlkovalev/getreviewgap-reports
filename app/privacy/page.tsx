...
export const metadata: Metadata = { title: "Privacy Policy", description: "How ReviewGap collects, stores, and protects your data. We do not share or sell your review reports or account information." }
