    ...
    <main className="px-5 py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-6 text-xl text-white/70">
          ReviewIntel Reports turns competitor Amazon reviews into product decisions, positioning angles, and ad hooks. It is designed for Shopify brands, Amazon sellers, and the agencies that support them.
        </p>
      </div>
    </main>
  )
